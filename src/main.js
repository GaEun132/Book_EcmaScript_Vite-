...
const fillFormWithBookData = (book) => {
    ...
    const { description ='',language='',pageCount='',publisher='',coverImageUrl='',edition='' } = detail
    ...
    elements.form.elements.edition.value = edition
...
const createBookRow = (book) => {
    // 구조분해할당으로 데이터 추출
    const { id, title = '', author = '', isbn = '', price = '', publishDate = '', detail } = book
